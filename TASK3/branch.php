      ...
      <tbody>
        ...
        ?>
            <tr>
              ...
              <td>
                <a href="update_branch.php?uid=<?php echo $row['id'] ?>" class="btn btn-success" style="margin-right: 10px; width:200px">Update</a><br><br>
                <a href="delete_branch.php?uid=<?php echo $row['id'] ?>" class="btn btn-warning" style="margin-right: 10px; width:200px">Delete</a> 

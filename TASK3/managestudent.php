        ...
        ?>
            <tr>
              ...
              <td><?php echo $row['class'] ?></td>
               <td>
                <a href="stupdate.php?sid=<?php echo $row['sid'] ?>" class="btn btn-primary"  style="margin-right: 10px; width:200px">Update</a><br><br>
                <a href="stdlt.php?sid=<?php echo $row['sid']?>" class="btn btn-secondary"  style="margin-right: 10px; width:200px">Delete</a>

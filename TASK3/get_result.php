...
<body id="result1">
  <div class="container">
    ...
    <div class="overlay">
                   <nav>
                        <div class="nav-logo">
                            <img src="../LetsGrowMore/pic/green.jpg" alt="">
                        </div>
                    </nav>
        ...
        <div class="result-box">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                     <?php
        // include "include/connection.php";
        $sq = "SELECT res_id,res_reg,os,co,java,dbms,ds,ai,(os+co+java+dbms+ds+ai)as total,((os+co+java+dbms+ds+ai)/(100*6) * 100) as per FROM result WHERE res_reg='{$reg}'";
